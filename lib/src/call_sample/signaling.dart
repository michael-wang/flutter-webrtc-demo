...
class Session {
  ...
  /// Peer id, self generated by client in [Signaling._selfId].
  /// Notice the example use 6 digits number which is NOT good practice.
  /// An UUID would be better choice here.
  String pid;

  /// Session id, defined by client. See how it's build (sessionId) in
  /// [Signaling.invite].
  String sid;
